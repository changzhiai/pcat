"""Sub workflow for dft"""""
import json, toml, sys
from pathlib import Path
import pandas as pd
from flow import dft
...
def workflow():
    ...
    dfting = dft(args["dft"]["folder"], deps=deps, iteration=iteration)
    print(f'======>{args["dft"]["folder"]}: iteration {iteration}')
    
    write_tasks(dfting, 'task_dfting')
