...
def get_chemical_potential(xls_name, sheet):
...
def plot_chem_vs_cons(xls_name, sheet):
    df = get_chemical_potential(xls_name, sheet)
...
def plot_chem_vs_pressure(xls_name, sheet):
    df = get_chemical_potential(xls_name, sheet)
...
if __name__ == '__main__':
    ...
    # get_chemical_potential(xls_name, sheet=sheet_name_convex_hull)
    plot_chem_vs_cons(xls_name, sheet=sheet_name_convex_hull)
    plot_chem_vs_pressure(xls_name, sheet=sheet_name_convex_hull)